...
/*
    ...
    참조하고 사용자가 입력한 사번의 사번,사원명,직급코드,급여,부서명 조회 후 각 변수에 담에서 출력
*/
...
-- NCODE 값이 KO가 아닐경우 -> TEAM = 해외팀 대입
-- 사번, 이름, 부서명, 소속(TEAM을 출력)
