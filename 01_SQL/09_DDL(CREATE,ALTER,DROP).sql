...
/*
    ...
    - 데이터 무결성 보장을 목적으로 함 -> 데이터 베이스에 저장된 데이터가 정확하고 일관되며 신뢰할 수 있는 상태를
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길순', '남', NULL,NULL,NULL,NULL);
...
CREATE TABLE MEMBER(
    ...
    EMAIL VARCHAR2(50),
    CREATE_AT DATE,
    CONSTRAINT EMAIL_UQ UNIQUE(EMAIL) -- 테이블 부여방식
);
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길순', '남', '여','010-1111-2222', 'aaa@naver.com','25/07/30');
-- CHECK 제약조건 때문에 '남','여' 이외에 성별 입력시 
-- 단, NULL 값이 없다는 뜻이기 때문에 CHECK 제약조건

--------------------------------------------------------------------------------
/*
    PRIMARY KEY(기본키) 제약조건
    테이블에서 각 행(ROW)를 식별하기 위해 사용될 컬럼에 부여하는 제약조건(식별자 역할)
    EX) 회원번호, 학번, 부서코드, 주민등록번호, 택배 운송장 번호...
...
INSERT INTO MEMBER
VALUES(1, 'USER02', 'PASS02', '홍길순', NULL,'010-1111-2222', 'aaa@naver.com','25/07/30');
...
INSERT INTO MEMBER
VALUES(1, 'USER01', 'PASS01', '홍길동', NULL,'010-1111-2222', 'aaa1@naver.com','25/07/30');

INSERT INTO MEMBER
VALUES(2, 'USER02', 'PASS01', '홍길순', NULL,'010-1111-2222', 'aaa2@naver.com','25/07/30');

INSERT INTO MEMBER
VALUES(3, 'USER03', 'PASS01', '홍길삼', NULL,'010-1111-2222', 'aaa3@naver.com','25/07/30');

INSERT INTO MEMBER
VALUES(4, 'USER04', 'PASS01', '홍길사', NULL,'010-1111-2222', 'aaa4@naver.com','25/07/30');
...
INSERT INTO MEM
VALUES(1, 'USER01', 'PASS01', '홍길동', NULL,'010-1111-2222', 'aaa1@naver.com','25/07/30',NULL);

INSERT INTO MEM
VALUES(2, 'USER02', 'PASS01', '홍길순', NULL,'010-1111-2222', 'aaa2@naver.com','25/07/30',10);

INSERT INTO MEM
VALUES(3, 'USER03', 'PASS01', '홍길삼', NULL,'010-1111-2222', 'aaa3@naver.com','25/07/30',NULL);

INSERT INTO MEM
VALUES(4, 'USER04', 'PASS01', '홍길사', NULL,'010-1111-2222', 'aaa4@naver.com','25/07/30',NULL);
...
-- 외래키를 가진 테이블이 자식, 1:N 관계에서는 1쪽이 자식테이블
-- 부모테이블 : 외래키로 참조되는 테이블
...
WHERE GRADE_CODE = 10;
-- MEM 테이블에서 10이라는 GRADE_ID가 있기 때문에 부모 테이블의 GRADE_CODE 10을 가진 데이터 삭제가 안됨.
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = 30;
-- MEM테이블에서 참조하고 있지 않은 30의 GRADE_CODE를 가진 데이터는 삭제가 가능함

-- 자식테이블에서 이미 사용하고 있는 값이 있을 경우
-- 부모테이블로부터 무조건 삭제가 안되는 "삭제 제한" 옵션이 기본값으로 설정되어 있음.

--------------------------------------------------------------------------------

/*
    자식테이블 생성시 외래키 제약조건 부여할 때 삭제옵션을 함께 지정가능
    *삭제옵션 : 부모테이블에 데이터 삭제시 그 데이터를 참조하고 있는 자식테이블의 데이터를 어떻게 처리할 것인가?
...
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = 40;
-- MEM_GRADE의 PK 데이터가 삭제되면 SET NULL옵션에 따라 
...
INSERT INTO MEM VALUES(2, 'USER01',24,NULL,NULL);
INSERT INTO MEM VALUES(3, 'USER03',27,DEFAULT,DEFAULT);

-- INSERT INTO 테이블명(컬럼1, 컬럼2) VALUES(값1, 값2);
INSERT INTO MEM(MEM_NO, MEM_ID, MEM_AGE) VALUES(4, 'USER04',27);
--> 선택되지 않은 컬럼에는 기본적으로 NULL이 적용됨
--> 단, 해당 컬럼에 DEFAULT값이 부여되어 있다면 NULL이 아닌 DEFAULT값이 적용
