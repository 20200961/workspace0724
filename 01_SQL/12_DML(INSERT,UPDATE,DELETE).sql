/*
    ...
    DCL(CONTROL 트랜잭션 제어어) : COMMIT, ROLLBACK
...
/*
    ...
    컬럼의 수와 순번을 지켜서 VALUES 값을 나열해야 한다.
...
VALUES(900,'김수민','880914-1234567','SD123@naver.com',01012347568,'D7','J5',4000000,0.2,200,SYSDATE,NULL,'N');
