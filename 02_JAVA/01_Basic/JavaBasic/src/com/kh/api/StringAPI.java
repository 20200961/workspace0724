...
public class StringAPI {
	public void method01() {
		...
		// String 클래스에서 hashCode 메서드도 이미 오버라이딩이 되어있음(주소값이 아닌 문자열을 가지고 해시값을 만들도록)
		...
		str3 = "bye";
		System.out.println(System.identityHashCode(str3));
		// String 리터러르이 특성상 참조변수의 값을 변경하는 순간 기존의 문자열 메모리의 값을 변경하는게 아니라
	...
	public void method02() {
		...
		System.err.println(str1.substring(6,9));
	...
	public void method03() {
		...
		System.out.println(stn.nextToken());
		System.out.println(stn.nextToken());
		// System.out.println(stn.nextToken()); 더이상 토큰이 남아있지 않을때 다음 토큰 호출시 예외발생
