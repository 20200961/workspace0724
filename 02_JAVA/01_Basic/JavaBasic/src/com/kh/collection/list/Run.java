...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 1.add(E e) : 리스트 공간 끝에 전달된 데이터 추가
		...
		// 2.add(int index, E e) : 직접 인덱스를 지정해서 해당위치에 데이터 추가
		...
		// 4.remove(E e) : 객체를 직접 지정해서 삭제(사용을 위해서는 객체의 equals를 적절하게 오버라이딩 해줘야함.)
		list.remove("이무진");
		...
		// 5.set(int index, E e) : 해당 인덱스의 값을 전달받은 e 객체로 덮어씌움
		...
		// 검색 search(E e) 데이터 검색 후 존재하면 위치반환(위에서 부터 샌다) -> equals를 사용하여 비교검색
