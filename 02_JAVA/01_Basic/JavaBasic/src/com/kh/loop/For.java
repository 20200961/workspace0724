...
public class For {
	 ...
	 * 		매번 반복문의 코드를 실행하기 전에 확인하며 보통 초기식에서 제시된 변수를 활용하며 조건식을 정함.
	 * 
...
//		System.out.println(Math.random());
		/*
		 * Math.random()
		 * java.lang.Math 클래스에서 기본적으로 제공하는 함수 호출하면 매번 다른 랜덤값을 반환한다.
		 * 
		 * Math.random() 호출시 -> 0.0 ~ 0.99999999999
...
//		}
		...
		// 사용자에게 문자열을 입력받아 해당 문자열의 짝수 자리만 출력
